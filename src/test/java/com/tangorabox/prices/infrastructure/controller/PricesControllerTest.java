...
import com.tangorabox.prices.AppConfigTest;
import com.tangorabox.prices.infrastructure.io.CSVReaderOpenCSV;
import com.tangorabox.prices.infrastructure.repository.PriceRepositoryImpl;
...
@ContextConfiguration(classes = {AppConfigTest.class,
        PricesController.class, PricesService.class, PricesDatabaseUpdater.class, CSVReaderOpenCSV.class, PriceRepositoryImpl.class})
public class PricesControllerTest {
    ...
    private void testEndPointWithDate(String date, double expectedPrice) {
        webTestClient.get()
                ...
                .value(priceResponse -> assertThat(priceResponse.getSalePrice().doubleValue()).isEqualTo(expectedPrice));
    }
